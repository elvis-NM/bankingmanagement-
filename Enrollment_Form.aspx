...
<body background="Images/windows-7-wallpaper-1920x1200.jpg">
    ...
    <table class="style1">
        <tr>
            ...
            <td style="font-family: 'Monotype Corsiva'; font-weight: 700; font-size: xx-large; text-align: justify; color: #999966; background-color: #333300;">
    ...
    <table class="style6">
        ...
        <tr>
            <td colspan="2" style="text-align: justify; background-color: #333300">
                &nbsp;</td>
        </tr>
    </table>
    <table class="style1">
        ...
        <tr>
            <td class="style7" colspan="2" 
                ...
                style="font-weight: 700; color: #999966; font-family: 'Bookman Old Style'; text-align: justify; background-color: #333300">
