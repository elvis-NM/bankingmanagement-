        ...
        <table style="width: 100%; height: 100%; border: 1px solid #c0c0c0">
            <tr>
                <td style="width: 1680px">
                    ...
                    <ul>
                        <li><b>$500.00 minimum to open</b></li>
                        <li><b>$10.00 monthly maintenance fees. Other miscellaneous fees will be charged at the 
                            published rate.</b></li>
                        <li><b>$0.20 per check or debit item over 100</b></li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li><b>$8.00 monthly maintenance fees. Other miscellaneous fees will be charged at 
                    the published rate.</b></li>
                <li><b>$10.00 fees per withrawal over six (6). Federal Law limits withdrawals to six 
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li><b>$500.00 minimum to open</b></li>
                <li><b>$10.00 monthly maintenance fees. Other miscellaneous fees will be charged at 
                    the published rate.</b></li>
                <li><b>Imaged checks</b></li>
                <li><b>Debit Card available with approval</b></li>
                <li><b>Item fees $0.10 checks or debits paid</b></li>
                <li><b>Item fees $0.05 per on-us item deposited</b></li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2" 
            style="text-align: center; font-weight: 700; font-family: 'Bookman Old Style'; color: #FFFFFF; background-color: #333300">
