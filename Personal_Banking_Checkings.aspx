                        ...
                        <tr>
                            <td>
                                ...
                                <ul>
                                    ...
                                    <li>West Side Bank and Trust ATM.</li>
                                ...
                                <p style="font-family: 'Bookman Old Style'">
                                    <b>Fees:-</b></p>
                                <ul>
                                    <li>Minimum $100 opening deposit required.</li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                ...
                                <ul>
                                    ...
                                    <li>West Side Bank &amp; Trust ATM &amp; Debit Card.</li>
                                </ul>
                                <p style="font-family: 'Bookman Old Style'">
                                    <b>Fees:-</b></p>
                                <ul>
                                    <li>No monthly fees with a minimum balance of $200.</li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <tr>
                        <td>
                            ...
                            <p style="font-family: 'Bookman Old Style'">
                                <b>Fees:-</b></p>
                            <ul>
                                <li>$10 Base Charge fee if balance falls below $1,000 during the month.</li>
                            </ul>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            ...
                            <p style="font-family: 'Bookman Old Style'">
                                <b>Fees:-</b></p>
                            <ul>
                                <li>$5 per month fees.</li>
                                <li>Transfers will be done in $10 increments.</li>
                            </ul>
                        </td>
                    </tr>
                </table>
